...
\figside{0.4}{0.05}{/home/aspiga/images/decouverte/cours_geomorpho/maree_1.png}{Mécanisme de l'effet de marée gravitationnelle. $\omega$ représente le sens de rotation de l'objet, qui tourne par rapport à l'attracteur (révolution) dans le sens inverse des aiguilles d'une montre. Crédits J. Laskar.}{fig:couplemaree}
