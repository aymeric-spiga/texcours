...
%(équilibre hydrostatique + équation d'état du gaz parfait) 
...
\begin{citemize}
\item les \voc{cellules de Hadley}, cellules fermées dans le plan méridien, sud-nord et verticale; sous les tropiques, l'air s'élève proche de l'équateur (suivant la saison, du côté de l'hémisphère d'été) et redescend aux subtropiques.
\item les \voc{\og brises \fg~de mer et de terre} sur Terre, naissant du contraste thermique entre continent et océan/mer
