...
* Comment est connue l'évolution ? Inventaire initial + ratios isotopiques
...
2. (initial) volatiles condensés et piégés dans les planétésimaux
...
* schéma Leconte et al.
  ...
  3. [Venus] lower equ T, H2O runaway greenhouse: abiotic O2 by photodissociation of water.
  4. [Mars/Earth] low equil T, H2O/CO2/N2 atmospheres: temperatures cold enough for solidification then release of volatiles. weathering
  5. [Titan] colder climates, CO2 greenhouse insufficient to prevent its condensation indefinitely. carbon compunds found as CO or CH4 depending on oxidizing state.
...
<!-- faire le point à la fin sur les exemples ??? -->

## Habitabilité

### exobiologie, des briques à la vie

* L'exobiologie a pour objet l'étude de la vie dans l'univers. Plus précisément, elle inclut 
    - l'étude des conditions et des processus qui ont permis l'émergence du vivant sur notre planète, et ont pu ou pourraient le permettre ailleurs, 
    - l’étude de l’évolution de la matière organique vers des structures complexes dans l’univers, 
    - les recherches qui concernent la distribution de la vie sous toutes les formes qu'elle pourrait revêtir, et son évolution.

* expérience de Miller/Urey CH4 NH3 H2O H2 + lightning
    - production d’une grande diversité de composés organiques dont des acides aminés
...
<!-- question des sources des organiques -->
* organiques : un grand nombre de molécules utilisées par la biochimie sur Terre (y compris amino-acides) sont dans:
    ...
    - comètes, astéroïde, météorites, etc... 
        - (par exemple Murchison plus de 70 acides aminés, 10^5 mol orga différentes) Schmitt-Koplin PNAS 2010
* molécules identifiées dans les comètes (voir tableau thèse A. Bardyn) <!-- Cottin 38 -->
    - 67P avec insitu COSAC mass spec: 16 composés orga, peuvent se former par irradiation UV et radiolyse des glaces Goesmann Science 2015
    - depuis l'orbite: prebiotic chemical (amino-acids et phosphorus) dans la coma de 67P par Altwegg Science Advances 2016

* donc vie = eau liquide, en ajoutant des conditions clémentes même si extrêmophiles
...
* Ajouter le concept d'océans souterrains (comme par exemple Europe [Europa Clipper] Ganymède [JUICE])

### Recherche des biomarqueurs

Une biosignature correspond à un gaz lié à la présence passée ou présente de biosphère.

* hors de l'équilibre thermodynamique (minimum de G): organismes émettent des gaz O2 N2 CO2 CH4 N2O etc (flux biogénique) O3 plus facile à détecter que O2
     - notamment par des redox reactions used by life to exploit chemical energy gradients and to produce energy-storing material
* étude de l'équilibre thermochimique (Terre)
     - exemple aucune molécule de CH4 ne devrait exister étant donné une atmosphère de la taille de la Terre avec 21% O2
     - et par ailleurs le déséquilibre le plus flagrant est entre N2 H2O O2
* quantitative obligatoirement (quel degré de déséquilibre ?) (see Catling and Bergsman Astrobiology 2010)
     - car photochemistry + volcanism can alter equilibrium (CO2 n'est ainsi pas un bon exemple)
     - exemple Mars et sa photochimie de CO, NO et O2
     - et présence très faible (qq ppbv) de CH4  (serpentinisation ? olivine + H2O)
...
* mais possibilité avec (du coup, faux positifs !)
     - effet de serre galopant en cours, par exemple sur Vénus avec photolyse et échappement de l'hydrogène!
     - origine abiotique possible à cause de la photolyse (X)UV de l’eau, protégée sur la Terre grâce eu piège froid (condensats)

<!--
* Catling: sur Terre O2 + humide = pas de brume organique (à cause de OH)
* les sulfates sont oxidés...
-->

biosignatures mineures, exemple methyl chloride CH3Cl
* Simple halogen hydrides have been detected in interstellar sources and in comets
* complex organohalogen CH3Cl detected in protostar and in comet 67P !!!


Autre méthode: des structures de réflectance particulières
* Earthshine: lumière diffusée par la Terre puis rediffusée par la Lune
* "red edge" in disk-integrated reflection spectra: sudden rise at l>0.7mic caused by reflection by photosynthetic vegetation


H. Cottin: exobio, est-elle une affaire d'astrophysiciens, de microbiologistes, de biologistes, de chimistes, de géologues, 
